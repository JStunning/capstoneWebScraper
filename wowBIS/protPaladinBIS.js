...
async function wowScraper(url) {
  ...
  finalList["Protection Paladin Tank"] = bisList.concat(bisQ1, bisQ2, bisQ3, bisQ4);
  console.log('bisQ1 ', bisQ1)
  console.log('bisQ2 ', bisQ2)
  console.log('bisQ3 ', bisQ3)
  console.log('bisQ4 ', bisQ4)

  fs.writeFileSync("protPaladinBIS.json", JSON.stringify(finalList));
  console.log('wrote file')

  browser.close();
}

wowScraper("https://classic.wowhead.com/guides/lights-bulwark-protection-paladin-tanking#pre-raid-best-in-slot");